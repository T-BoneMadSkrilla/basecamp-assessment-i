...
var trueFaveNum = 7;
if (trueFaveNum == faveNum){trueFaveNum=true};
...
if (myName!=notHakeem){notHakeem=true};
// CODE HERE
...
var responseCreator = function(param){
  ...
  if(param==="red"){return "I heart red"}
  if(param!=="green"||"red"){return "What is your favorite color?"};
